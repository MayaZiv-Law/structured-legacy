  ...
  const content = {
    ...
    he: {
      ...
      sections: [
        {
          title: '1. מידע כללי',
          content: 'אתר זה מופעל ע"י עו"ד מאיה זיו, תל אביב. כל התוכן באתר מיועד למידע כללי בלבד ואינו מהווה ייעוץ משפטי או חוות דעת. גלישה באתר או יצירת קשר דרכו אינם יוצרים יחסי עורך דין-לקוח.'
        },
        {
