...
const EstatePlanning = () => {
  ...
  return <Layout>
      ...
      <section className="py-10 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div ref={epaAnim.ref} className={cn("max-w-4xl mx-auto p-6 bg-card rounded-lg border border-border transition-all duration-700", isRTL && "font-hebrew text-right", epaAnim.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}>
            <h3 className="text-xl font-display font-medium mb-3">
              {t('estate.epa.title')}
            </h3>
            <p className="text-muted-foreground text-lg">
