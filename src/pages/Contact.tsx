  ...
  return (
    <Layout>
      ...
      <section className="pb-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div ref={contentAnim.ref} className={cn("max-w-2xl mx-auto bg-card rounded-lg shadow-lg p-8 lg:p-12 transition-all duration-700", contentAnim.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}>
            <div className={cn(isRTL && "font-hebrew text-right")}>
              ...
              <div className={cn("flex gap-4 mt-10", isRTL && "flex-row-reverse")}>
                <a href="https://wa.me/972544943597" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border border-border/50 flex items-center justify-center text-foreground hover:text-accent hover:border-accent transition-colors" aria-label="WhatsApp">
                ...
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border border-border/50 flex items-center justify-center text-foreground hover:text-accent hover:border-accent transition-colors" aria-label="LinkedIn">
