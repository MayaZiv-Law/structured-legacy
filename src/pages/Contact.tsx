              ...
              <div className={cn(isRTL && "font-hebrew text-right")}>
                ...
                <div className="space-y-6">
                  ...
                  <div className={cn("flex items-center gap-4", isRTL && "flex-row-reverse")}>
                    ...
                    <a href="tel:+97236123456" className="text-foreground hover:text-accent transition-colors">+972-3-612-3456</a>
                  </div>
                  <div className={cn("flex items-start gap-4", isRTL && "flex-row-reverse")}>
                    <MapPin className="h-5 w-5 text-accent shrink-0 mt-0.5" />
                    <span className="text-foreground">{isRTL ? 'רוטשילד 45, תל אביב' : '45 Rothschild Blvd, Tel Aviv'}</span>
                  </div>
                </div>
                <div className={cn("flex gap-4 mt-10", isRTL && "flex-row-reverse")}>
                  <a href="https://wa.me/97236123456" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-border/50 flex items-center justify-center text-foreground hover:text-accent hover:border-accent transition-colors" aria-label="WhatsApp">
