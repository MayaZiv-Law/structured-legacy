  ...
  return (
    <Layout>
      ...
      <section className="pb-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div ref={contentAnim.ref} className={cn("max-w-2xl mx-auto bg-card rounded-lg shadow-lg p-6 lg:p-10 transition-all duration-700", contentAnim.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}>
