...
const Contact = () => {
  ...
  return (
    <Layout>
      ...
      <section className="section-spacer-md">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Contact Form */}
            <div ref={formAnim.ref} className={cn("bg-card rounded-lg shadow-premium p-6 lg:p-10 transition-all duration-700", formAnim.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                      ...
                      <input
                        ...
                        className={cn("w-full px-4 py-3 rounded-md text-foreground input-premium", isRTL && "text-right")}
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className={cn("w-full px-4 py-3 rounded-md text-foreground input-premium resize-none", isRTL && "text-right")}
                      />
                    </div>
            ...
            {/* Contact Info */}
            <div ref={contentAnim.ref} className={cn("bg-card rounded-lg shadow-premium p-6 lg:p-10 transition-all duration-700", contentAnim.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}>
              <div className={cn(isRTL && "font-hebrew text-right")}>
                <h2 className="text-fluid-2xl font-display font-semibold text-foreground mb-8">{language === 'he' ? 'פרטי התקשרות' : 'Contact Info'}</h2>
                ...
                <div className={cn("flex gap-4 mt-10", isRTL && "flex-row-reverse")}>
                  <a href="https://wa.me/972544943597" target="_blank" rel="noopener noreferrer" className="w-14 h-14 sm:w-12 sm:h-12 rounded-full border border-border/50 flex items-center justify-center text-foreground hover:text-accent hover:border-accent hover:shadow-premium transition-all duration-300" aria-label="WhatsApp">
                  ...
                  <a href="https://www.linkedin.com/in/maya-ziv/" target="_blank" rel="noopener noreferrer" className="w-14 h-14 sm:w-12 sm:h-12 rounded-full border border-border/50 flex items-center justify-center text-foreground hover:text-accent hover:border-accent hover:shadow-premium transition-all duration-300" aria-label="LinkedIn">
