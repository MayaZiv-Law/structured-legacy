  ...
  return (
    <Layout>
      ...
      <section className="pb-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 overflow-hidden rounded-lg shadow-lg">
            ...
            <div className="lg:col-span-3 bg-card p-8 lg:p-12">
              <div className={cn(isRTL && "font-hebrew text-right")}>
                ...
                <p className="text-muted-foreground mb-8">
                  {language === 'he' 
                    ? 'מלאו את הטופס הקצר כדי שנוכל ליצור איתכם קשר בהקדם האפשרי ולהתחיל לתכנן את הפתרון המשפטי המתאים לכם.'
                    : 'Please fill out this brief questionnaire so that we can contact you as soon as possible to begin planning the right legal solution for you.'}
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className={cn("space-y-5", isRTL && "font-hebrew")}>
                <div>
                  ...
                  <Input 
                    ...
                    required 
                    className={cn("border-border/50 focus:border-accent", isRTL && "text-right")} 
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea 
                    ...
                    required 
                    rows={4} 
                    className={cn("border-border/50 focus:border-accent resize-none", isRTL && "text-right")} 
                  />
                </div>
                <Button 
                  type="submit" 
            ...
            {/* Contact Info Section - Beige/Muted Background */}
            <div className="lg:col-span-2 bg-muted/50 p-8 lg:p-12 flex flex-col justify-center">
              <div className={cn(isRTL && "font-hebrew text-right")}>
                <h2 className="text-3xl font-display font-semibold text-foreground mb-8">
                  {language === 'he' ? 'פרטי התקשרות' : 'Contact info'}
                </h2>
                
                <div className="space-y-6">
                  <div className={cn("flex items-center gap-4", isRTL && "flex-row-reverse")}>
                    <Mail className="h-5 w-5 text-accent shrink-0" />
                    <a href="mailto:info@mayaziv.law" className="text-foreground hover:text-accent transition-colors">
                      info@mayaziv.law
                    </a>
                  </div>
                  ...
                  <div className={cn("flex items-center gap-4", isRTL && "flex-row-reverse")}>
                    ...
                    <a href="tel:+97236123456" className="text-foreground hover:text-accent transition-colors">
                      +972-3-612-3456
                    </a>
                  </div>
                ...
                <div className={cn("flex gap-4 mt-10", isRTL && "flex-row-reverse")}>
                  <a 
                    href="https://wa.me/97236123456" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full border border-border/50 flex items-center justify-center text-foreground hover:text-accent hover:border-accent transition-colors"
                    aria-label="WhatsApp"
                  >
