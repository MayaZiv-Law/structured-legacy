...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'olim.context.body': 'Beginning a new chapter in Israel brings opportunity, complexity, and important legal choices. The decisions you make in the first months of arrival, from how you classify your residency to when you purchase property and how you transfer capital, will affect your tax position, banking relationships, and financial structure for years to come. We provide patient, personalized, and structured legal guidance for Olim Hadashim and Returning Residents. Each client receives a clear roadmap tailored to their specific situation, so that no critical step is missed and no benefit is forfeited through poor timing or incomplete documentation.',
    'olim.context.body2': '',
