...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'estate.challenge.body': 'Families with assets in Israel and ties to other countries face a specific challenge. Ensuring that wealth passes to the next generation efficiently, in accordance with the client\'s wishes, and without unnecessary tax events or procedural delays. Israeli inheritance law operates under its own rules of formality, jurisdiction, and procedure. When foreign wills, foreign beneficiaries, or assets in multiple countries are involved, the complexity increases significantly. The firm develops structured estate plans that integrate Israeli inheritance law with relevant foreign legal frameworks. The objective is to prevent disputes, minimise probate delays, and reduce exposure to double taxation or conflicting succession orders.',
    ...
    'realestate.approach.body': 'For many clients, acquiring property in Israel is both a personal milestone and a significant financial commitment. The legal framework governing Israeli real estate is technically demanding. Title verification, planning compliance, tax classification, and staged payment structures each carry consequences if mishandled. The firm provides end to end legal counsel across the entire acquisition process, from preliminary due diligence through contract negotiation to final registration at the Israel Land Registry (Tabu). Every stage is managed with the analytical rigour that comes from a background in both law and finance.',
    ...
    'realestate.faq.a2': 'Buyer funds in Israeli property transactions are released to the seller in stages, tied to specific legal milestones rather than as a lump sum. At each stage, a corresponding security interest is registered in the buyer\'s favour at the Land Registry, known as a Hearat Azhara (warning note). This mechanism ensures that if the transaction does not complete, the buyer\'s financial exposure is limited. The payment schedule and its linkage to milestones is one of the most important elements of the purchase contract and is negotiated before signing.',
    ...
    'tax.context.body2': 'The firm approaches every engagement with the financial discipline that comes from Maya Ziv\'s background in finance and accounting. By integrating tax planning into the legal process from the outset, we minimise regulatory friction, support full compliance, and protect the client\'s standing with Israeli financial institutions and tax authorities.',
    ...
    'tax.olim.body': 'New immigrants (Olim Hadashim) and qualifying returning residents (Toshav Hozer Vatik) may be eligible for significant tax and reporting reliefs, including the ten year exemption from reporting on foreign income in certain cases. These benefits are subject to strict eligibility criteria, classification rules, and timing requirements. The firm helps clients map their status, understand the implications of each classification, and structure the timing and documentation of their transition to support a compliant and tax efficient entry into the Israeli system.',
    ...
    'olim.context.body': 'Relocating to Israel is both a personal milestone and a complex legal transition. The decisions you make in the first months of arrival, from how you classify your residency to when you purchase property and how you transfer capital, will affect your tax position, banking relationships, and financial structure for years to come. The firm provides structured, patient, and personalised legal guidance for Olim Hadashim and returning residents. Each client receives a clear roadmap tailored to their specific situation, so that no critical step is missed and no benefit is forfeited through poor timing or incomplete documentation.',
    'olim.context.body2': '',
    ...
    'commercial.services.dispute.desc': 'Pre litigation analysis, settlement frameworks, and litigation management where required. The firm\'s approach prioritises the client\'s commercial interest, whether that calls for determined enforcement or a negotiated resolution.',
