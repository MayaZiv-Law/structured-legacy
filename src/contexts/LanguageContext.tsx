...
const translations: Record<Language, Record<string, string>> = {
  ...
  he: {
    ...
    'hero.subtitle2': 'נדל"ן, מיסוי ותכנון עיזבון. שירות משפטי מקצועי ויסודי.',
    'hero.cta': 'בקשת ייעוץ חסוי',
    'hero.ctaSecondary': 'איך עובד התהליך?',

    // Conflict Section
    'conflict.title': 'בהירות במקום שהפרטים קובעים את התוצאה',
    'conflict.body': 'עבור לקוחותינו בישראל ובחו"ל, אנו מביאים פרספקטיבה בינלאומית שנבנתה מתוך הכשרה פיננסית בחו"ל ופרקטיקה משפטית בישראל, יחד עם הבנה מקומית מעמיקה. שילוב זה מאפשר לנו להציע ייעוץ דו-לשוני בעניינים מקומיים וחוצי גבולות, תוך שמירה על קרבה לצרכי הלקוח, בניית מערכות יחסים ארוכות טווח והפיכת מצבים מורכבים להחלטות ממוקדות ובטוחות.',
    ...
    'parallax.quote': 'אנו מתאמים בין הביצוע המשפטי להשלכות הפיננסיות, מהיום הראשון.',
