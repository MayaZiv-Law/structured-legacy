...
const translations: Record<Language, Record<string, string>> = {
  ...
  he: {
    ...
    // About Page
    'about.hero.title': 'ייעוץ משפטי בראייה פיננסית',
    ...
    'about.philosophy.body': 'המשרד הוקם כדי להעניק ללקוחות ליווי משפטי מקומי ובינלאומי, המבוסס על רקע אקדמי בהיר. המשרד מביא ניסיון מקצועי ותקשורת פיננסית קפדנית, על מנת לתכנן משפטית וגלובלית בהתאם לסטנדרטים אנליטיים.',
    'about.philosophy.body2': 'לקוחות המשרד נהנים מליווי שקוף ומובנה בסוגיות תכנון נכסיהם, לטווח הארוך, תוך שמירה על ההחלטות האישיות והמשפחתיות שלהם.',
    ...
    'about.expect.title': 'למה לקוחות בוחרים בנו',
    'about.expect.intro': 'המשרד מלווה את לקוחותיו, בין אם הם מתגוררים בישראל או מעבר לים, תוך שילוב ציפיות ברורות ותקשורת קפדנית.',
    'about.expect.doc.title': 'מומחיות בינלאומית',
    'about.expect.doc.desc': 'המשרד מאפשר גישור בין מערכות משפטיות ורגולציות, עם הכשרה בינלאומית וידע מדויק על תרבויות שונות.',
    'about.expect.timeline.title': 'שקיפות ובהירות',
    'about.expect.timeline.desc': 'אנו מאמינים בשקיפות וביטחון לקוחותינו, ומייצרים מסגרת בהגדרת התקשרות ארוכת טווח במערכות יחסים.',
    'about.expect.comm.title': 'חשיבה אסטרטגית',
    'about.expect.comm.desc': 'פתרונות עמידים בתכנון פיננסי, נבחנים בדיוק ובחשיבה משפטית ארוכת טווח.',
    'about.expect.foresight.title': 'מחויבות אישית',
    'about.expect.foresight.desc': 'לקוחותינו מקבלים מחויבות מלאה ומקצועית, עם שיקול דעת בכיר, למטרותיהם המשפטיות.',
    ...
    'realestate.approach.body': 'עבור לקוחות רבים, רכישת נכס בישראל מייצגת יותר מהשקעה. זהו אבן דרך אישית והחלטה אסטרטגית עם השלכות פיננסיות ארוכות טווח. המשרד מספק הדרכה משפטית חלקה לאורך כל תהליך הרכישה, כולל בדיקת נאותות, סקירת חוזה ורישום בלשכת רישום המקרקעין של ישראל. כל שלב מטופל בבהירות, משמעת וראיית הנולד, מבטיח עסקה חלקה ומאובטחת.',
    'realestate.approach.body2': 'אנו מספקים הדרכה משפטית מובנית שנועדה לאבטח את הנכס. מבדיקות מקדמיות ועד לרישום בלשכת רישום המקרקעין (טאבו), כל שלב מטופל בבהירות, משמעת וראיית הנולד כדי להבטיח העברת בעלות תואמת.',
    'realestate.risk.title': 'הפחתת חשיפה בשוק מורכב',
    'realestate.risk.intro': 'דיני המקרקעין הישראליים מטילים את נטל האימות על הקונה. בדיקת הנאותות שלנו נועדה לזהות ולנטרל סיכונים לפני שאתם חותמים:',
    'realestate.risk.liabilities.title': 'חבויות נסתרות',
    'realestate.risk.liabilities.desc': 'איתור שעבודים, חובות או משכנתאות קיימים הצמודים לנכס.',
    'realestate.risk.planning.title': 'תכנון וייעוד',
    'realestate.risk.planning.desc': 'אימות שהנכס בנוי כחוק ותואם להיתרים עירוניים למניעת ירידת ערך או קנסות עתידיים.',
    'realestate.risk.tax.title': 'חשיפת מס',
    'realestate.risk.tax.desc': 'זיהוי בעיות תזמון או סיווגי תושבות שעלולים לעורר חבויות מס מיותרות.',
    'realestate.tax.title': 'שיקולים רגולטוריים ומיסויים',
    'realestate.tax.body': 'מס רכישה בישראל הוא דינמי. תושבי חוץ בדרך כלל כפופים למדרגות מס שונות בהשוואה לעולים חדשים (אולים) או תושבים חוזרים.',
    'realestate.tax.body2': 'מס רכישה בישראל חל באופן שונה בהתאם לפרופיל הלקוח. קונים זרים בדרך כלל כפופים למדרגות מס גבוהות יותר, בעוד שעולים חדשים ותושבים חוזרים עשויים להיות זכאים לתעריפים מופחתים על פי החוק הישראלי. בהסתמך על היכרות מעמיקה עם הרגולציה והדרישות המיסויות הישראליות, המשרד מכין ומגיש כל דיווח בדייקנות ובזמן, מבטיח שלקוחות נהנים מכל הפטורים החוקיים ועוברים את התהליך ללא מכשולים מנהליים או עיכובים רגולטוריים.',
    'realestate.diligence.title': 'בדיקת נאותות קפדנית',
    'realestate.diligence.body': 'עסקה מאובטחת מתחילה באימות. לפני כל התחייבות, אנו עורכים ביקורת משפטית מקיפה של הנכס. זה כולל אימות בעלות, בדיקת שעבודים וסקירת מצב התכנון.',
    'realestate.diligence.body2': 'ניתוח מובנה זה מאפשר לכם לקבל החלטה מושכלת המבוססת על עובדות מתועדות, מבטיח שהנכס שאתם רואים הוא הנכס שאתם רוכשים משפטית.',
    'realestate.remote.title': 'ייצוג ללקוחות בחו"ל',
    'realestate.remote.body': 'לקוחות המתגוררים מחוץ לישראל יכולים להשלים את כל תהליך הרכישה מרחוק. הייצוג מתבצע באמצעות ייפוי כוח בלתי חוזר הנחתם בקונסוליה ישראלית או בפני נוטריון עם אפוסטיל, מאפשר השלמה מאובטחת, תואמת ויעילה של העסקה.',
    'realestate.remote.body2': 'זה מאפשר לנו לנהל את העסקה בשמכם, ממשא ומתן ועד לרישום סופי, מאפשר לכם להשלים את הרכישה בבטחה תוך שהייה בחו"ל.',
