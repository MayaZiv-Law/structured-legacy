...
const translations: Record<Language, Record<string, string>> = {
  ...
  he: {
    ...
    'insights.article1.title': 'רכישת נכס בישראל כתושב חוץ: יסודות משפטיים ומיסויים',
    ...
    'insights.article2.title': 'צוואות וירושה בישראל: הבטחת תוקף חוצה גבולות',
    ...
    'insights.article3.title': 'רכישת נכס בישראל: בדיקות משפטיות חיוניות לקונים מקומיים',
