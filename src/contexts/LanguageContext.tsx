...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'guide.bio': 'We founded the practice on a single premise. The best legal advice on complex transactions requires financial literacy, not just legal knowledge. Maya Ziv holds an LLB and a BBA in Finance. This background shapes how every matter is approached.',
    ...
    'method.step5.desc': 'Structured preparation for purchase tax, capital gains, and reporting duties aligns Israeli obligations with foreign tax regimes, minimizing liability.',
    ...
    'about.philosophy.body': 'Maya Ziv Law advises private clients and businesses on matters where legal and financial decisions cannot be separated. The firm was founded on a single premise. Navigating complex transactions in Israel requires both legal rigor and genuine financial literacy. Maya Ziv holds an LLB from the College of Law and Business and a BBA in Finance and Accounting from Baruch College, New York. Prior to entering legal practice, she held roles at Citi Innovation Lab and Vornado Realty Trust. The firm is based in Israel and accepts clients in Hebrew and English.',
    ...
    'about.attorney.body2': 'We prioritize prevention over reaction. Matters are structured from the outset to reduce future exposure through documentation, verification, and clear contractual drafting. Clients receive a defined process, clear timelines, and full visibility on costs from the first engagement.',
    ...
    'realestate.approach.body': 'For many clients, acquiring property in Israel is both a personal milestone and a significant financial commitment. The legal framework governing Israeli real estate is technically demanding. Title verification, planning compliance, tax classification, and staged payment structures each carry consequences if mishandled. We provide end to end legal counsel across the entire acquisition process, from preliminary due diligence through contract negotiation to final registration at the Israel Land Registry (Tabu). Every stage is managed with the analytical rigor that comes from a background in both law and finance.',
    'realestate.approach.body2': 'Prior experience in financial and operational roles informs our approach to property transactions. The result is legal advice that accounts not only for regulatory compliance but also for the financial structure, timing, and long term consequences of every decision.',
    ...
    'realestate.remote.body': 'Clients who reside abroad can complete the entire acquisition remotely. We act under an irrevocable power of attorney, signed at an Israeli consulate or before a notary with apostille. This enables full legal representation without requiring physical presence in Israel.',
    ...
    'realestate.faq.a2': 'Buyer funds in Israeli property transactions are released to the seller in stages, tied to specific legal milestones rather than as a lump sum. At each stage, a corresponding security interest is registered in the buyer\'s favor at the Land Registry, known as a Hearat Azhara (warning note). This mechanism ensures that if the transaction does not complete, the buyer\'s financial exposure is limited. The payment schedule and its linkage to milestones is one of the most important elements of the purchase contract and is negotiated before signing.',
    ...
    'tax.faq.a2': 'No. Israeli banks operate under strict anti money laundering regulations and conduct independent due diligence on every incoming international transfer. A transfer that is not accompanied by clear documentation of source, purpose, and beneficial ownership may be held, returned, or subjected to extended review. We prepare a structured source of funds file in advance to facilitate acceptance.',
    ...
    'olim.context.body': 'Relocating to Israel is both a personal milestone and a complex legal transition. The decisions you make in the first months of arrival, from how you classify your residency to when you purchase property and how you transfer capital, will affect your tax position, banking relationships, and financial structure for years to come. We provide structured, patient, and personalized legal guidance for Olim Hadashim and returning residents. Each client receives a clear roadmap tailored to their specific situation, so that no critical step is missed and no benefit is forfeited through poor timing or incomplete documentation.',
    'olim.context.body2': '',
    ...
    'olim.framework.peace.desc': 'We communicate in both English and Hebrew and coordinates with the client\'s foreign advisors where needed. The goal is to translate complex Israeli legal processes into clear, practical steps, providing confidence during one of life\'s most significant transitions.',
    ...
    'olim.clients.body': 'This practice area is designed for individuals and families relocating to Israel who hold significant assets, foreign income, or cross border financial structures. It is particularly relevant for clients who value a disciplined, compliance first approach and who understand that the legal and financial decisions made during the transition period will shape their position in Israel for years to come.',
