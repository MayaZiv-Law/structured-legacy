...
const translations: Record<Language, Record<string, string>> = {
  ...
  he: {
    ...
    // Estate Planning Page
    'estate.hero.title': 'ניהול עזבונות, צוואות וירושה',
    ...
    'estate.wills.conflict.desc': 'עריכת הסדר משפטי המאפשר לקבוע מראש את זהות מנהלי העניינים האישיים והרכושיים למצבי אובדן כשירות.',
