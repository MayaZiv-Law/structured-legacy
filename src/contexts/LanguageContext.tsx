...
const translations: Record<Language, Record<string, string>> = {
  ...
  he: {
    ...
    'method.step1.title': 'פרספקטיבה מקומית ובינלאומית',
    'method.step1.desc': 'המשרד מלווה תושבי ישראל ולקוחות העולים לישראל או מתגוררים מעבר לים, תוך הקפדה על תקשורת ברורה, תיאום ציפיות ושילוב חלק בין מערכות משפט שונות.',
    'method.step2.title': 'מומחיות בעסקאות בינלאומיות',
    'method.step2.desc': 'שילוב של השכלה בינלאומית, הכשרה פיננסית ופרקטיקה משפטית בישראל מאפשר גישור מדויק בין תרבויות, רגולציות ומערכות דין.',
    'method.step3.title': 'שקיפות לאורך כל הדרך',
    'method.step3.desc': 'אנו מאמינים במערכות יחסים ארוכות טווח, כל התקשרות נפתחת בהגדרת מסגרת ברורה, לוחות זמנים מדויקים ושקיפות שמייצרת בעבור לקוחותינו ביטחון.',
    'method.step4.title': 'חשיבה אסטרטגית',
    'method.step4.desc': 'כל סוגיה נבחנת בדיוק משפטי, פיננסי ובתכנון פתרונות עמידים וארוכי טווח.',
    'method.step5.title': 'מחויבות אישית',
    'method.step5.desc': 'לקוחותינו מקבלים ליווי אישי, בשיקול דעת מקצועי ומחויבות מלאה למטרותיהם.',
    'method.step6.title': 'תחומי עיסוק',
    'method.step6.desc': 'נדל"ן והשקעות, מיסוי, תכנון עזבונות ירושות וצוואות, עולים חדשים ותושבים חוזרים, פיננסי ומסחרי',
    ...
    'faq.a1': 'הערכת מס צריכה להתבצע בשלב המקדמי עוד לפני החתימה על מסמך מחייב. זיהוי סטטוס התושבות והטבות המס (לעולים חדשים או תושבים חוזרים) בשלב המשא ומתן מאפשר אופטימיזציה של חבויות המס ומונע הפתעות פיננסיות.',
    'faq.q2': 'כיצד מובטחת הגנה על כספי הרוכש במהלך העסקה?',
    'faq.a2': 'הכספים מוחזקים לרוב בחשבון נאמנות (Escrow) ומשוחררים למוכר אך ורק בהתאם לעמידה באבני דרך משפטיות שנקבעו מראש בחוזה המכר כגון רישום הערת אזהרה לטובתכם בלשכת רישום המקרקעין.',
    ...
    'faq.a6': 'תושבות לצרכי מס נקבעה על פי מבחן מרכז החיים (שהייה של מעל 183 ימים בשנה) ולא רק על בסיס אזרחות. אנו מייעצים לגבי הקריטריונים המשפטיים ובוחנים כיצד הנוכחות שלכם בישראל משפיעה על הסטטוס.',
    'faq.q7': 'האם צוואה זרה תקפה בישראל?',
    'faq.a7': 'מימוש צוואה זרה מחייב הליך של אישור צוואה לפי דין זר המערב חוות דעת מומחים. עריכת צוואה ישראלית נפרדת המיועדת לנכסים בארץ מפשטת את התהליך באופן משמעותי וחוסכת עלויות.',
    ...
    'faq.q10': 'האם ניתן לנהל את הליך הירושה מרחוק?',
    'faq.a10': 'כן. אנו מטפלים בהליכים מול הרשם לענייני ירושה והבנקים באמצעות ייפוי כוח כך שאינכם נדרשים לשהות בישראל לצורך קבלת הצו או חלוקת הכספים.',
    ...
    'footer.disclaimerText': '© 2026 עו"ד מאיה זיו. כל הזכויות שמורות. התוכן באתר זה מיועד למידע כללי בלבד ואינו מהווה ייעוץ משפטי. שימוש באתר או יצירת קשר דרכו אינם יוצרים יחסי עורך דין לקוח. לקבלת ייעוץ משפטי אישי, צרו קשר ישיר עם המשרד.',
    'footer.copyright': '© 2026 עו"ד מאיה זיו. כל הזכויות שמורות.',

    // Contact Page
    'contact.title': 'צור קשר',
    'contact.subtitle': 'כל לקוח, כל החלטה וכל פרט מקבלים תשומת לב מלאה ויחס מקצועי.',
