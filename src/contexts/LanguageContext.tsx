...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'olim.context.body': 'Relocation to Israel is not only a personal move—it is a legal and financial transition. Early decisions around residency timing, documentation, and asset positioning can shape your tax exposure and administrative friction for years to come.',
    'olim.context.body2': 'We provide structured, documentation-led guidance that turns complex processes into a clear roadmap. Our goal is to help you move forward with clarity and control, rather than reacting to bureaucracy as it happens.',
