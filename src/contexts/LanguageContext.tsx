...
const translations: Record<Language, Record<string, string>> = {
  ...
  he: {
    ...
    'guide.bio': 'משרד מאיה זיו נבנה על שילוב של פרספקטיבה משפטית ופיננסית, תוך הטמעת משמעת אנליטית בכל עניין. הפרקטיקה משרתת לקוחות בישראל ובחו"ל עם ייעוץ דו-לשוני בנושאים מקומיים וחוצי גבולות, תוך התמקדות במבנה ברור וביטחון לטווח ארוך לעסקיהם, נכסיהם ותכניותיהם האישיות.',
    'guide.punchline': 'אנחנו חושבים קדימה עבור הלקוחות שלנו, משתמשים בתובנה ובשיקול דעת יצירתי כדי להנחות את החלטותיהם ולצפות את צרכיהם.',
    ...
    'about.philosophy.body': 'משרד מאיה זיו הוקם כדי לשרת לקוחות מקומיים ובינלאומיים הזקוקים לייעוץ משפטי דו-לשוני המושתת על מבנה משפטי, תובנה פיננסית ותקשורת ברורה. עם רקע אקדמי בינלאומי וניסיון מקצועי מוקדם בפיננסים ובחשבונאות, הפרקטיקה מביאה משמעת אנליטית ומקצועיות גלובלית לסביבה המשפטית הישראלית.',
    'about.philosophy.body2': 'הלקוחות נהנים מהדרכה מובנית ושקופה בעניינים המעצבים רכוש, תכנון משפחתי והחלטות אישיות לטווח ארוך.',
    ...
    'about.expect.intro': 'ההתקשרות עם המשרד עוקבת אחר מסלול מוגדר ושקוף. אנו מאמינים שבהירות היא התרופה ללחץ, במיוחד כאשר מנהלים עניינים מרחוק.',
    'about.expect.doc.title': 'גישה מבוססת תיעוד',
    'about.expect.doc.desc': 'אנו מתחילים באימות. החלטות מתקבלות על בסיס עובדות ורשומות רשמיות, לא הנחות.',
    'about.expect.timeline.title': 'פרספקטיבה מקומית ובינלאומית',
    'about.expect.timeline.desc': 'עם שורשים בהשכלה בינלאומית, הכשרה פיננסית ופרקטיקה משפטית ישראלית, המשרד מגשר על הבדלים תרבותיים ורגולטוריים בדיוק ובראיית הנולד.',
    'about.expect.comm.title': 'בהירות ושקיפות',
    'about.expect.comm.desc': 'כל התקשרות מתחילה עם ציפיות מוגדרות, לוחות זמנים מובנים ונראות מלאה של העלויות, יוצרת חוויית לקוח יציבה וצפויה.',
    'about.expect.foresight.title': 'ראיית הנולד אסטרטגית',
    'about.expect.foresight.desc': 'עניינים נבחנים עם דיוק משפטי, חשיבה פיננסית ותכנון לטווח ארוך כדי להבטיח תוצאות מחושבות ועמידות.',
