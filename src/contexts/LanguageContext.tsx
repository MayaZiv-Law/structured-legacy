...
const translations: Record<Language, Record<string, string>> = {
  ...
  he: {
    ...
    'olim.context.title': 'ניהול משפטי של תהליך המעבר',
    'olim.context.body': 'מעבר הון ופעילות משפטית בישראל מחייבים תכנון מקדים ומימוש זכויות רגולטוריות. המשרד מעניק ליווי מובנה הממוקד בניהול סיכונים ומיצוי הטבות:',
    'olim.context.body2': '',
