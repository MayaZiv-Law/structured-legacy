...
const translations: Record<Language, Record<string, string>> = {
  ...
  he: {
    ...
    // Taxation Page
    'tax.hero.title': 'מיסוי וציות',
    'tax.hero.subtitle': '',
    'tax.context.title': 'אסטרטגיית מס וניהול הון',
    'tax.context.body': 'הערכת מס מוקדמת היא רובד קריטי בניהול עסקת מקרקעין. המשרד מתמחה באופטימיזציה של חבויות מס עבור תושבי ישראל ולקוחות בינלאומיים המנהלים נכסים בתחומי שיפוט שונים:',
    'tax.context.body2': '',
