...
const translations: Record<Language, Record<string, string>> = {
  ...
  he: {
    ...
    'estate.epa.body': 'עריכת הסדר משפטי המאפשר לקבוע מראש את זהות מנהלי העניינים האישיים והרכושיים למצבי אובדן כשירות.',
    ...
    'tax.context.body': 'הערכת חשיפת מס בניהול עסקת מקרקעין. המשרד מתמחה באופטימיזציה של חבויות מס עבור תושבי ישראל ולקוחות בינלאומיים המנהלים נכסים בתחומי שיפוט שונים:',
    ...
    'tax.banking.body': 'העברת הון לישראל דורשת עמידה ברגולציה מחמירה של איסור הלבנת הון. המשרד מלווה את הלקוח בבניית תיק מקור כספים (Source of Funds) סדור להבטחת קליטת הכספים במערכת הבנקאית.',
    ...
    'tax.crossBorder.body': 'בחינת השלכות המס בישראל אל מול חובות דיווח זרות במטרה למנוע כפל מס ולהגן על הערך הכלכלי של ההשקעה.',
    ...
    'commercial.services.crossborder.desc': 'המשרד משמש נציגות משפטית אופרטיבית בישראל עבור גופים הפועלים מחוץ למדינה הכולל אכיפת פסקי חוץ וניהול זכויות בעלי מניות.',
