...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'hero.h1': 'In an ever-changing world, Maya Ziv Law stands as a dedicated legal partner, combining on-the-ground knowledge with global perspective.',
    'hero.subtitle2': '',
  ...
  he: {
    ...
    'hero.h1': 'בעולם המשתנה ללא הרף, משרד מאיה זיו עומד לצד לקוחותיו כשותף משפטי מסור, המשלב היכרות מעמיקה עם המציאות המקומית עם פרספקטיבה וניסיון בינלאומיים.',
