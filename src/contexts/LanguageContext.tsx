...
const translations: Record<Language, Record<string, string>> = {
  ...
  he: {
    ...
    'about.attorney.body2': 'אנחנו מעדיפים מניעה ומבנה. העבודה שלנו מתוכננת להפחית חיכוך, להגן על עמדות מוקדם ולמנוע מחלוקות לפני שהן מתעוררות. על ידי צפייה של מכשולים רגולטוריים ומבנה נכון של עסקאות מההתחלה, המטרה היא ליצור יציבות ולהבטיח שההסדרים המשפטיים שלכם ישרתו את המורשת הפיננסית והאישית שלכם לטווח ארוך.',
