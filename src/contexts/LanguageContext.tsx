...
const translations: Record<Language, Record<string, string>> = {
  ...
  he: {
    ...
    'commercial.philosophy.body2': 'אנו בוחנים כל סוגיה דרך שלוש עדשות: זכויות חוזיות, חשיפה פיננסית, ואכיפה עתידית (בישראל ובחו"ל). מטרתנו היא לייצר דיוק חוזי שיצמצם חיכוך ועלויות מיותרות, ככל שניתן.',
    'commercial.services.title': 'מסגרת העבודה שלנו',
    'commercial.services.contracts.title': 'ניסוח וסקירת חוזים',
    'commercial.services.contracts.desc': 'בדיקת חוזים מסחריים (Contract Review) וניסוח הסכמים המגדירים מנגנונים ברורים לקבלת החלטות, תוך זיהוי מוקשים משפטיים מראש.',
    'commercial.services.negotiation.title': 'משא ומתן ומיצוב סיכון',
    'commercial.services.negotiation.desc': 'ליווי משא ומתן מסחרי מתוך ראייה עסקית, במטרה לשפר את העמדה שלכם ולצמצם חשיפה משפטית ופיננסית.',
    'commercial.services.dispute.title': 'אסטרטגיית סכסוך ויישובו',
    'commercial.services.dispute.desc': 'ניהול סכסוכים חוזיים ועסקיים מורכבים. אנו בונים אסטרטגיה המעדיפה את האינטרס הכלכלי, בין אם באמצעות ליטיגציה נחושה ובין אם בחתירה לפשרה חכמה.',
    'commercial.services.crossborder.title': 'תיעוד חוצה גבולות',
    'commercial.services.crossborder.desc': 'לוקליזציה של מסמכים וחוזים זרים והתאמתם לדין המקומי, כדי לתמוך באכיפה ובהתנהלות תקינה מול דרישות הדין הישראלי.',
    'commercial.crossborder.title': 'הזרוע המשפטית שלכם בישראל',
    'commercial.crossborder.body': 'עבור חברות ומשקיעים זרים, ניהול אינטרסים בישראל מרחוק הוא אתגר.',
    'commercial.crossborder.body2': 'אנו מספקים ייצוג מעשי "על הקרקע". בין אם מדובר באכיפת חוזה זר בישראל, ובין אם בהגנה על אינטרס של בעל מניות מקומי כאשר אתם בחו"ל - אנו דואגים לאינטרסים שלכם ומספקים עדכונים מסודרים ומתועדים באנגלית.',
