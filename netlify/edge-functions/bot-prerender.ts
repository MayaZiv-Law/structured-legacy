...
function buildFallbackHtml(url: URL): string {
  ...
  const content = isHebrew ? {
    ...
    practices: [
      ...
      { name: 'פיננסי ומסחרי', desc: 'חוזים, חלוקת סיכונים וייעוץ עסקי', href: '/he/commercial' },
    ],
    ...
    practices: [
      ...
      { name: 'Commercial and Finance', desc: 'Contracts, risk allocation and business counsel', href: '/en/commercial' },
    ],
